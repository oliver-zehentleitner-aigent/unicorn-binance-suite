...
| **DepthCache cluster**                                                                                        | **UBDCC** — `pip install ubdcc` on any machine, or scale on Kubernetes. Load balancing, failover, REST API | — | — | — |
...
| **Stream signals**                                                                                            | `CONNECT`, `FIRST_RECEIVED_DATA`, `DISCONNECT`, `STOP`, `STREAM_UNREPAIRABLE` — know the exact state of every stream | No | No | No |
...
| **WebSocket API (order placement via WS)**                                                                    | Yes — [Spot](https://oliver-zehentleitner.github.io/unicorn-binance-websocket-api/unicorn_binance_websocket_api.html#module-unicorn_binance_websocket_api.api.spot) and [Futures](https://oliver-zehentleitner.github.io/unicorn-binance-websocket-api/unicorn_binance_websocket_api.html#module-unicorn_binance_websocket_api.api.futures) | No | Partially | Yes |
| **SOCKS5 proxy**                                                                                              | Yes — per connection | No | No | No |
